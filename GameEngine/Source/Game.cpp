...
bool Game::loadData()
{
	...
	//NPCs
	gKing = std::make_shared<NPC>(STRING_KING_NAME, FILE_KING_TEXTURE.string(), FILE_KING_DIALOGUE_TEXTURE.string(), STRING_KING_CONTEXT, RDF_INVESTIGATION_ASSIGNED_FALSE, 0.3f, 0.7f, 0.4f);
	gFather = std::make_shared<NPC>(STRING_FATHER_NAME, FILE_FATHER_TEXTURE.string(), FILE_FATHER_DIALOGUE_TEXTURE.string(), STRING_FATHER_CONTEXT, "", 0.5f, 0.2f, 0.3f);
