...
bool Game::loadData()
{
	...
	gFather = std::make_shared<NPC>(STRING_FATHER_NAME, FILE_FATHER_TEXTURE.string(), FILE_FATHER_DIALOGUE_TEXTURE.string(), STRING_FATHER_CONTEXT);
	gRoyalGuard = std::make_shared<NPC>(STRING_ROYALGUARD_NAME, FILE_ROYALGUARD_TEXTURE.string(), FILE_ROYALGUARD_DIALOGUE_TEXTURE.string(), STRING_ROYALGUARD_CONTEXT);
	gInnkeeper = std::make_shared<NPC>(STRING_INNKEEPER_NAME, FILE_INNKEEPER_TEXTURE.string(), FILE_INNKEEPER_DIALOGUE_TEXTURE.string(), STRING_INNKEEPER_CONTEXT);
	gMarquis = std::make_shared<NPC>(STRING_MARQUIS_NAME, FILE_MARQUIS_TEXTURE.string(), FILE_MARQUIS_DIALOGUE_TEXTURE.string(), STRING_MARQUIS_CONTEXT);
